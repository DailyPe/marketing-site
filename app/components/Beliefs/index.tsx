        ...
        <div className='mx-auto max-w-2xl lg:max-w-7xl sm:py-4 lg:px-8 rounded-3xl'>
            <div className='grid grid-cols-1 lg:grid-cols-2 my-16 mx-5 gap-5'>
                ...
                <div className="bg-darkblue bg-beliefs pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    ...
                    <h5 className="text-offwhite pt-2 mb-5 text-center sm:text-start">At DailyPe, we uphold the values of honesty and hard work, driving our commitment to delivering exceptional design solutions.</h5>
                ...
                <div className="bg-build pt-12 px-10 sm:px-24 pb-52 md:pb-70 rounded-3xl">
                    ...
                    <h5 className="bluish pt-2 mb-5 text-center sm:text-start">Empower your vision by partnering with DailyPe. We specialize in turning your concepts into reality</h5>
